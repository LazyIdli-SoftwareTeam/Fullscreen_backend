...
const LMS_BACKEND_LINK = 'http://13.127.235.58:3001/';
// const LMS_BACKEND_LINK = 'http://localhost:3001/';
const KIOSK_ID = 'PTK-005';
...
app.listen(3300, () => {
//	open("http://localhost:3002", {app: { name: "firefox"}});
  console.log('app is working on port 3300')
//require('child_process').exec('firefox-esr -kiosk -private-window http://localhost:3002/?kioskId=PTK-005');
});
